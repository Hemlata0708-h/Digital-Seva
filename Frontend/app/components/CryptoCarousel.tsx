  ...
  useEffect(() => {
    const fetchCryptoPrices = async () => {
      try {
        ...
        const coinGeckoIds = "ethereum,binancecoin,matic-network,avalanche-2,arbitrum,optimism";
        ...
        // No need to fetch specificResponse if marketResponse already has all the needed data.
        // We will just map directly from marketData.

        const carouselCurrencies = marketData.map((coin: any) => ({
          id: coin.id,
          name: coin.name,
        ...
        // Fallback dummy data for when CoinGecko API is rate-limited (429)
        const dummyCurrencies = [
          { id: "ethereum", name: "Ethereum", symbol: "ETH", price: 3500, image: "https://assets.coingecko.com/coins/images/279/large/ethereum.png", price_change_percentage_24h: 2.1, market_cap: 400000000000 },
          { id: "binancecoin", name: "BNB", symbol: "BNB", price: 600, image: "https://assets.coingecko.com/coins/images/825/large/bnb-icon2_2x.png", price_change_percentage_24h: -0.5, market_cap: 90000000000 },
          { id: "matic-network", name: "Polygon", symbol: "MATIC", price: 1.2, image: "https://assets.coingecko.com/coins/images/4713/large/matic-token-icon.png", price_change_percentage_24h: 3.4, market_cap: 10000000000 },
          { id: "avalanche-2", name: "Avalanche", symbol: "AVAX", price: 35, image: "https://assets.coingecko.com/coins/images/12559/large/Avalanche_Circle_RedWhite_Trans.png", price_change_percentage_24h: 1.2, market_cap: 12000000000 },
          { id: "arbitrum", name: "Arbitrum", symbol: "ARB", price: 1.5, image: "https://assets.coingecko.com/coins/images/16547/large/AkbDHEpq_400x400.jpeg", price_change_percentage_24h: 4.0, market_cap: 3000000000 },
          { id: "optimism", name: "Optimism", symbol: "OP", price: 2.8, image: "https://assets.coingecko.com/coins/images/25244/large/Optimism.png", price_change_percentage_24h: 2.5, market_cap: 2500000000 },
        ];
        setAllCryptoPrices(dummyCurrencies);
        setMarketStats({ totalMarketCap: 1780000000000, totalVolume: 89000000000, activeCoins: 6 });
        setPriceError(null);
      } finally {
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-50 via-white to-red-50 border border-orange-200 shadow-xl mb-8">
        ...
        {!loadingPrices && !priceError && allCryptoPrices.length > 0 && (
          <div className="relative">
            ...
            >
              {duplicatedCryptos.map((crypto: any, index: number) => (
                <div
                  key={`${crypto.id}-${index}`}
